                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-xs text-gray-500 font-semibold">@{selectedUser.username || selectedUser.user}</span>
                      ...
                      <div className="col-span-4 flex items-center gap-3">
                        ...
                        <div className="flex flex-col min-w-0">
                          ...
                          <div className="flex items-center gap-1.5">
                            <span className="text-[10px] text-gray-600 group-hover:text-gray-500 transition-colors">@{row.username || row.user}</span>
            ...
            >
              ...
              <div className="flex items-center gap-4 w-full">
                ...
                <div className="flex flex-col min-w-0 flex-1">
                  ...
                  <span className="text-[9px] text-gray-500 font-semibold truncate">@{myStanding.username || myStanding.user}</span>
                </div>
