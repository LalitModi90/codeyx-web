...
const sheetsData = [
  { slug: 'striver-a2z', title: 'Striver A2Z DSA Sheet', desc: 'Complete DSA roadmap from beginner to advanced.', problems: 455, icon: 'Code2', color: 'from-purple-600 to-indigo-600', text: 'text-purple-400', bg: 'bg-purple-500/10' },
  { slug: 'love-babbar', title: 'Love Babbar Sheet', desc: '450 selected questions to build strong problem solving skills.', problems: 450, icon: 'Heart', color: 'from-emerald-600 to-green-600', text: 'text-emerald-400', bg: 'bg-emerald-500/10' },
  { slug: 'neetcode-150', title: 'Neetcode 150', desc: 'The most popular 150 LeetCode patterns for FAANG interviews.', problems: 150, icon: 'Zap', color: 'from-blue-600 to-cyan-600', text: 'text-blue-400', bg: 'bg-blue-500/10' },
  { slug: 'blind-75', title: 'Blind 75', desc: 'Curated list of 75 Leetcode questions to land a job at top tech companies.', problems: 75, icon: 'Target', color: 'from-purple-500 to-fuchsia-600', text: 'text-fuchsia-400', bg: 'bg-fuchsia-500/10' },
  { slug: 'top-interview-150', title: 'Top Interview 150', desc: 'Must-do questions directly recommended by top tech companies.', problems: 150, icon: 'Briefcase', color: 'from-violet-600 to-purple-600', text: 'text-violet-400', bg: 'bg-violet-500/10' },
  { slug: 'striver-sde', title: 'Striver SDE Sheet', desc: 'Top 190 questions for last-minute SDE interview preparation.', problems: 190, icon: 'Code2', color: 'from-orange-600 to-red-600', text: 'text-orange-400', bg: 'bg-orange-500/10' },
  { slug: 'dp-master', title: 'DP Master Sheet', desc: 'Handpicked DP questions to become a DP master.', problems: 120, icon: 'Brain', color: 'from-pink-600 to-rose-600', text: 'text-pink-400', bg: 'bg-pink-500/10' },
  { slug: 'system-design', title: 'System Design Sheet', desc: 'Learn system design with real-world case studies and problems.', problems: 85, icon: 'Box', color: 'from-sky-600 to-blue-600', text: 'text-sky-400', bg: 'bg-sky-500/10' },
];
...
export default function ExploreSheetsPage() {
  ...
  const striverProgress = progressMap.get('striver-a2z');
  const featuredSolved = striverProgress?.solvedProblems || 0;
  const featuredRemaining = striverProgress?.remainingProblems || 0;
  const featuredRevision = striverProgress?.revisionPending || 0;
  const featuredPercent = striverProgress?.progressPercentage || 0;
              ...
              <div className="flex items-center gap-4">
                <Link href="/sheets/striver-a2z">
                  <button className="bg-gradient-to-r from-[#FF8A00] to-orange-500 text-white px-8 py-3 rounded-xl text-sm font-bold flex items-center gap-2 shadow-[0_8px_25px_rgba(255,138,0,0.3)] hover:scale-105 transition-transform active:scale-95">
                    <Play size={16} className="fill-current" /> {isSignedIn && featuredPercent > 0 ? 'Continue Sheet' : 'Start Sheet'}
                  </button>
                </Link>
                <Link href="/sheets/striver-a2z">
            ...
            <div className="flex items-center gap-10 bg-black/20 p-6 rounded-2xl border border-white/5 backdrop-blur-sm">
              <div className="relative w-32 h-32 flex-shrink-0">
                <svg viewBox="0 0 36 36" className="w-full h-full transform -rotate-90">
                  ...
                  <circle cx="18" cy="18" r="16" fill="none" stroke="#FF8A00" strokeWidth="2.5" strokeDasharray="100" strokeDashoffset={100 - featuredPercent} strokeLinecap="round" />
                </svg>
                <div className="absolute inset-0 flex flex-col items-center justify-center drop-shadow-lg">
                  <span className="text-3xl font-black text-white">{featuredPercent}%</span>
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-black text-white leading-none mb-1">{featuredSolved}</div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-black text-white leading-none mb-1">{featuredRemaining}</div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="text-sm font-black text-white leading-none mb-1">{featuredRevision}</div>
