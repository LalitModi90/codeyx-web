  ...
  const handleNext = () => {
    if (step < 5) {
      ...
      completeFullProfile({
        ...
        jobRole,
        // Save these extended properties if needed inside local context
      });
    }
  };
        ...
        <div className="bg-[#101014] border border-white/5 rounded-[20px] p-6 md:p-8 shadow-2xl relative">
            ...
            {step === 1 && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {/* Graduation Year */}
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-wider text-[#A1A1AA] mb-1.5 ml-1">Graduation Year</label>
                    <select
                      value={gradYear}
                  ...
                  {/* Target Job Role */}
                  <div>
                    <label className="block text-[10px] font-bold uppercase tracking-wider text-[#A1A1AA] mb-1.5 ml-1">Target Job Role</label>
                    <select
                      value={jobRole}
          ...
          <div className="flex items-center justify-between border-t border-white/5 mt-8 pt-6">
            ...
            >
              ...
              {step === 5 ? <Check size={16} /> : <ChevronRight size={16} />}
            </button>
          </div>
